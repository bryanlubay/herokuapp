    ...
    <div>
      <h1>Coronavirus</h1>
        ...
        <div className="card-chart">
          <p id="chart-header" className="x-axis"><div className="days-vs-infected">Date (February 2021 / March 2021) VS <div className="red-text">Positive Cases</div> and <div className="blue-text">Deaths</div></div> </p>
          {lineChart}
        </div>
