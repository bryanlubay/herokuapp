     ...
     [
      {
        label: 'Deaths',
        data: [
          [localStorage.getItem("deaths1"), 123], //  localStorage.getItem("dates1")] ,
          [localStorage.getItem("deaths2"), 123], //  localStorage.getItem("dates2")] ,
          [localStorage.getItem("deaths3"), 123], //  localStorage.getItem("dates3")] ,
          [localStorage.getItem("deaths4"), 123], //  localStorage.getItem("dates4")] ,
          [localStorage.getItem("deaths5"), 123], //  localStorage.getItem("dates5")] ,
          [localStorage.getItem("deaths6"), 123], //  localStorage.getItem("dates6")] ,
          [localStorage.getItem("deaths7"), 123], //  localStorage.getItem("dates7")] ,
          [localStorage.getItem("deaths8"), 123], //  localStorage.getItem("dates8")] ,
          [localStorage.getItem("deaths9"), 123], //  localStorage.getItem("dates9")] ,
          [localStorage.getItem("deaths10"), 123], //  localStorage.getItem("dates10")] ,
          [localStorage.getItem("deaths11"), 123], //  localStorage.getItem("dates11")] ,
          [localStorage.getItem("deaths12"), 123], //  localStorage.getItem("dates12")] ,
          [localStorage.getItem("deaths13"), 123], //  localStorage.getItem("dates13")] ,
          [localStorage.getItem("deaths14"), 123] //  localStorage.getItem("dates14")] 
        ]
      },
      {
        label: 'Infected',
        data: [
          [localStorage.getItem("positives1"), 456], // localStorage.getItem("dates1") ],
          [localStorage.getItem("positives2"), 456], // localStorage.getItem("dates2") ],
          [localStorage.getItem("positives3"), 456], // localStorage.getItem("dates3") ],
          [localStorage.getItem("positives4"), 456], // localStorage.getItem("dates4") ],
          [localStorage.getItem("positives5"), 456], // localStorage.getItem("dates5") ],
          [localStorage.getItem("positives6"), 456], // localStorage.getItem("dates6") ],
          [localStorage.getItem("positives7"), 456], // localStorage.getItem("dates7") ],
          [localStorage.getItem("positives8"), 456], // localStorage.getItem("dates8") ],
          [localStorage.getItem("positives9"), 456], // localStorage.getItem("dates9") ],
          [localStorage.getItem("positives10"), 456], // localStorage.getItem("dates10") ],
          [localStorage.getItem("positives11"), 456], // localStorage.getItem("dates11") ],
          [localStorage.getItem("positives12"), 456], // localStorage.getItem("dates12") ],
          [localStorage.getItem("positives13"), 456], // localStorage.getItem("dates13") ],
          [localStorage.getItem("positives14"), 456] // localStorage.getItem("dates14") ]
        ]
      }
    ],
    []
