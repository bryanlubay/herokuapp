     ...
     [
      {
        label: 'Deaths',
        data: [
          [localStorage.getItem("deaths1"), 1]// localStorage.getItem("dates1")] ,
          [localStorage.getItem("deaths2"), 2]// localStorage.getItem("dates2")] ,
          [localStorage.getItem("deaths3"), 3]// localStorage.getItem("dates3")] ,
          [localStorage.getItem("deaths4"), 4]// localStorage.getItem("dates4")] ,
          [localStorage.getItem("deaths5"), 5]// localStorage.getItem("dates5")] ,
          [localStorage.getItem("deaths6"), 6]// localStorage.getItem("dates6")] ,
          [localStorage.getItem("deaths7"), 7]// localStorage.getItem("dates7")] ,
          [localStorage.getItem("deaths8"), 8]// localStorage.getItem("dates8")] ,
          [localStorage.getItem("deaths9"), 9]// localStorage.getItem("dates9")] ,
          [localStorage.getItem("deaths10"), 10]// localStorage.getItem("dates10")] ,
          [localStorage.getItem("deaths11"), 11]// localStorage.getItem("dates11")] ,
          [localStorage.getItem("deaths12"), 12]// localStorage.getItem("dates12")] ,
          [localStorage.getItem("deaths13"), 13]// localStorage.getItem("dates13")] ,
          [localStorage.getItem("deaths14"), 14]// localStorage.getItem("dates14")] 
        ]
      },
      {
        label: 'Infected',
        data: [
          [localStorage.getItem("positives1"), 1]//localStorage.getItem("dates1") ],
          [localStorage.getItem("positives2"), 2]//localStorage.getItem("dates2") ],
          [localStorage.getItem("positives3"), 3]//localStorage.getItem("dates3") ],
          [localStorage.getItem("positives4"), 4]//localStorage.getItem("dates4") ],
          [localStorage.getItem("positives5"), 5]//localStorage.getItem("dates5") ],
          [localStorage.getItem("positives6"), 6]//localStorage.getItem("dates6") ],
          [localStorage.getItem("positives7"), 7]//localStorage.getItem("dates7") ],
          [localStorage.getItem("positives8"), 8]//localStorage.getItem("dates8") ],
          [localStorage.getItem("positives9"), 9]//localStorage.getItem("dates9") ],
          [localStorage.getItem("positives10"), 10]//localStorage.getItem("dates10") ],
          [localStorage.getItem("positives11"), 11]//localStorage.getItem("dates11") ],
          [localStorage.getItem("positives12"), 12]//localStorage.getItem("dates12") ],
          [localStorage.getItem("positives13"), 13]//localStorage.getItem("dates13") ],
          [localStorage.getItem("positives14"), 14]//localStorage.getItem("dates14") ]
        ]
      }
    ],
    []
