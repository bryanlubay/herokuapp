...
The FDA is warning consumers about alcohol-based hand sanitizers that are being packaged in containers that may appear as food or drinks and some that contain food flavors. Eating or drinking these products can cause serious injury or death. <a target="_blank" href="https://www.fda.gov/news-events/press-announcements/covid-19-update-fda-warns-consumers-about-hand-sanitizer-packaged-food-and-drink-containers">FDA Warning</a>
            ...
            <ul>
              ...
              <li className="prevent-li">Washing your hands with soap and water for 20 seconds (or using a hand sanitizer with at least 60% alcohol) at < target="_blank"a href="https://www.cdc.gov/handwashing/when-how-handwashing.html">key times</a></li>
            ...
            <ul>
              ...
              See <a target="_blank" href="https://www.fda.gov/consumers/consumer-updates/safely-using-hand-sanitizer">FDA’s Tips for Safe Sanitizer Use</a> and < target="_blank"a href="https://www.cdc.gov/handwashing/hand-sanitizer-use.html">CDC's Hand Sanitizer Use Considerations</a>
...
<br></br><a target="_blank" href="https://www.cdc.gov/coronavirus/2019-ncov/need-extra-precautions/people-at-higher-risk.html">People of any age who have certain underlying medical conditions</a> are at risk for getting COVID-19. Some groups have an <a target="_blank" href="https://www.cdc.gov/coronavirus/2019-ncov/need-extra-precautions/people-at-higher-risk.html">increased risk for severe illness</a> from coronavirus disease 2019 (COVID-19). The following information is aimed to help you protect those who are most vulnerable in your household.</p>
            ...
            <p className="prevent-p">Shared or congregate housing includes apartments, condominiums, student or faculty housing, national and state park staff housing, transitional housing, and domestic violence and abuse shelters.<br></br>Shared housing residents often gather together closely for social, leisure, and recreational activities, shared dining, laundry facilities, stairwells, and elevators and may have challenges with < target="_blank"a href="https://www.cdc.gov/coronavirus/2019-ncov/prevent-getting-sick/social-distancing.html">social distancing</a> to prevent the spread of COVID-19.</p>
              ...
              <Accordion>
                ...
                <Card><a id="Prevention"><Card.Header className="alert-subjects">Prevention</Card.Header></a>
                  ...
                  <Accordion.Collapse eventKey="16">
                    <Card.Body className="accordion-answer">Clean and disinfect frequently touched surfaces such as tables, doorknobs, light switches, countertops, handles, desks, phones, keyboards, toilets, faucets, and sinks.  If surfaces are dirty, clean them using detergent or soap and water prior to disinfection. To disinfect, most common EPA-registered household disinfectants will work. See CDC’s recommendations < target="_blank"a href="https://www.cdc.gov/coronavirus/2019-ncov/prevent-getting-sick/cleaning-disinfection.html">for household cleaning and disinfection</a>.</Card.Body>
                  </Accordion.Collapse>
                ...
                <Card><a id="Testing"><Card.Header className="alert-subjects">Testing</Card.Header></a>
                  ...
                  <Accordion.Collapse eventKey="44">
                    <Card.Body className="accordion-answer">
                      ...
                      COVID-19 testing differs by location. If you have symptoms of COVID-19 and want to get tested, call your healthcare provider first. You can also visit your <a target="_blank" href="https://www.cdc.gov/publichealthgateway/healthdirectories/healthdepartments.html">state</a> or < target="_blank"a href="https://www.naccho.org/membership/lhd-directory">local</a> health department’s website to look for the latest local information on testing. The U.S. Food and Drug Administration (FDA) has authorized viral tests that let you collect either a <a target="_blank" href="https://www.fda.gov/news-events/press-announcements/coronavirus-covid-19-update-fda-authorizes-first-test-patient-home-sample-collection">nasal swab</a> or a <a target="_blank" href="https://www.fda.gov/news-events/press-announcements/coronavirus-covid-19-update-fda-authorizes-first-diagnostic-test-using-home-collection-saliva">saliva sample</a> at home. However, you will still need to send your sample to a laboratory for analysis.<br></br><br></br>
                ...
                <Card><a id="Contact-Tracing"><Card.Header className="alert-subjects">Contact Tracing</Card.Header></a>
                  ...
                  <Accordion.Collapse eventKey="59">
                    <Card.Body className="accordion-answer">
                      If you have been around someone who was identified as a close contact to a person with COVID-19, closely monitor yourself for any < target="_blank"a href="https://www.cdc.gov/coronavirus/2019-ncov/symptoms-testing/symptoms.html">symptoms of COVID-19</a>. You do not need to self-quarantine unless you develop symptoms or if the person identified as a close contact develops COVID-19.
                        </Card.Body>
                  </Accordion.Collapse>
                ...
                <Card><a id="Funerals"><Card.Header className="alert-subjects">Funerals</Card.Header></a>
                  ...
                  <Accordion.Collapse eventKey="67">
                    <Card.Body className="accordion-answer">CDC does not require an autopsy before the remains of a person who died overseas are returned to the United States. Depending on the circumstances surrounding the death, some countries may require an autopsy. Sources of support to the family include the local consulate or embassy, travel insurance provider, tour operator, faith-based and aid organizations, and the deceased’s employer. There likely will need to be an official identification of the body and official documents issued by the consular office.<br></br><br></br>
                        CDC requirements for importing human remains depend upon if the body has been embalmed, cremated, or if the person died from a < target="_blank"a href="https://www.cdc.gov/quarantine/aboutlawsregulationsquarantineisolation.html">quarantinable communicable disease</a>.<br></br><br></br>
                  ...
                  <Accordion.Collapse eventKey="80">
                    <Card.Body className="accordion-answer">
                      Although we know certain bacteria and fungi can be carried on fur and hair, there is no evidence that viruses, including the virus that causes COVID-19, can spread to people from the skin, fur, or hair of pets.<br></br><br></br>
                        However, because animals can sometimes carry other germs that can make people sick, it’s always a good idea to practice < target="_blank"a href="https://www.cdc.gov/healthypets/publications/stay-healthy-pets.html">healthy habits</a> around pets and other animals, including washing hands before and after interacting with them.
                        </Card.Body>
                  </Accordion.Collapse>
                      ...
                      <ul>
                        ...
                        <li>When finished handling and cleaning game:<br></br>
                          <ul>
                            ...
                            <li>Clean knives, equipment, and surfaces that were in contact with game meat with soap and water and then disinfect them. While these recommendations apply to general food safety practices, if you are concerned about COVID-19, you may use a product on the < target="_blank"a href="https://www.epa.gov/newsroom/list-n-disinfectants-use-against-sars-cov-2">EPA list of disinfectants for use against the COVID-19 Virus</a></li>
      ...
      <br></br><Image src="https://www.cdc.gov/coronavirus/2019-ncov/images/prevent-getting-sick/facemask-instructions-sewn-04.png"></Image><br></br><br></br>
            ...
            <ul>
              ...
              <li className="masks-li">People should not wear masks while engaged in activities that may cause the mask to become wet, like when < target="_blank"a href="https://www.cdc.gov/coronavirus/2019-ncov/community/parks-rec/public-beaches.html">swimming at the beach or pool</a>. A wet mask may make it difficult to breathe. For activities like swimming, it is particularly important to maintain physical distance from others when in the water.</li>
            ...
            <ul>
              ...
              <li className="masks-li">Kimball A HK, Arons M, et al. Asymptomatic and Presymptomatic SARS-CoV-2 Infections in Residents of a Long-Term Care Skilled Nursing Facility — King County, Washington, March 2020. MMWR Morbidity and mortality weekly report. 2020; ePub: 27 March 2020. < target="_blank"a href="https://pubmed.ncbi.nlm.nih.gov/32240128/">PMID: 32240128</a></li>
              ...
              <li className="masks-li">Furukawa NW, Brooks JT, Sobel J. Evidence Supporting Transmission of Severe Acute Respiratory Syndrome Coronavirus 2 While Presymptomatic or Asymptomatic [published online ahead of print, 2020 May 4]. Emerg Infect Dis. 2020;26(7):10.3201/eid2607.201595. < target="_blank"a href="https://wwwnc.cdc.gov/eid/article/26/7/20-1595_article">Link</a></li>
          ...
          <Alert className="alert" id="if_you_are_sick" variant="danger" onClose={() => hide_if_you_are_sick()} dismissible hidden="true">
            ...
            <br></br><p className="sick-subject">Clean all “high-touch” surfaces everyday</p><ul>
              ...
              <ul>
                ...
                <li className="sick-li">Most EPA-registered household disinfectants should be effective. A full list of disinfectants can be found < target="_blank"a href="https://www.epa.gov/pesticide-registration/list-n-disinfectants-use-against-sars-cov-2"></a>here.</li>
      ...
      Caregivers and anyone who has been in close contact with someone who has COVID-19 should stay home. Learn <a target="_blank" href="https://www.cdc.gov/coronavirus/2019-ncov/if-you-are-sick/quarantine.html">when and how to quarantine</a>.
            ...
            <p className="sick-p">Deciding when it is safe to be around others is different for different situations. Find out when someone who is sick can < target="_blank"a href="https://www.cdc.gov/coronavirus/2019-ncov/prevent-getting-sick/when-its-safe.html">safely end home isolation</a>.</p>
      ...
      *COVID-19 <a target="_blank" href="https://www.cdc.gov/coronavirus/2019-ncov/symptoms-testing/symptoms.html">symptoms</a> can look different in different people. For many people, being sick with COVID-19 would be a little bit like having the flu. People can get a fever, cough, or have a hard time taking deep breaths. Most people who have gotten COVID-19 have not gotten very sick. Only a small group of people who get it have had more serious problems. <a target="_blank" href="https://www.cdc.gov/coronavirus/2019-ncov/daily-life-coping/children.html">More information on children and COVID-19</a>.
            ...
            <p className="sick-p"><a target="_blank" href="https://www.cdc.gov/coronavirus/2019-ncov/if-you-are-sick/index.html">If you have or think you might have COVID-19</a>, it is important to stay home and away from other people. Staying away from others helps stop the spread of COVID-19. <b>If you have < target="_blank"a href="https://www.cdc.gov/coronavirus/2019-ncov/symptoms-testing/symptoms.html#seek-medical-attention">an emergency warning sign</a> (including trouble breathing),</b> get emergency medical care immediately.</p>
