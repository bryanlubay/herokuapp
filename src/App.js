     ...
     [
      {
        label: 'Deaths',
        data: [
          [123, localStorage.getItem("deaths1")    ], //  localStorage.getItem("dates1")] ,
          [123, localStorage.getItem("deaths2")    ], //  localStorage.getItem("dates2")] ,
          [123, localStorage.getItem("deaths3")    ], //  localStorage.getItem("dates3")] ,
          [123, localStorage.getItem("deaths4")    ], //  localStorage.getItem("dates4")] ,
          [123, localStorage.getItem("deaths5")    ], //  localStorage.getItem("dates5")] ,
          [123, localStorage.getItem("deaths6")    ], //  localStorage.getItem("dates6")] ,
          [123, localStorage.getItem("deaths7")    ], //  localStorage.getItem("dates7")] ,
          [123, localStorage.getItem("deaths8")    ], //  localStorage.getItem("dates8")] ,
          [123, localStorage.getItem("deaths9")    ], //  localStorage.getItem("dates9")] ,
          [123, localStorage.getItem("deaths10")   ]   , //  localStorage.getItem("dates10")] ,
          [123, localStorage.getItem("deaths11")   ]   , //  localStorage.getItem("dates11")] ,
          [123, localStorage.getItem("deaths12")   ]   , //  localStorage.getItem("dates12")] ,
          [123, localStorage.getItem("deaths13")   ]   , //  localStorage.getItem("dates13")] ,
          [123, localStorage.getItem("deaths14")   ] //  localStorage.getItem("dates14")] 
        ]
      },
      {
        label: 'Infected',
        data: [
          [456, localStorage.getItem("positives1") ]  ,// ]  , // localStorage.getItem("dates1") ],
          [456, localStorage.getItem("positives2") ]  ,// ]  , // localStorage.getItem("dates2") ],
          [456, localStorage.getItem("positives3") ]  ,// ]  , // localStorage.getItem("dates3") ],
          [456, localStorage.getItem("positives4") ]  ,// ]  , // localStorage.getItem("dates4") ],
          [456, localStorage.getItem("positives5") ]  ,// ]  , // localStorage.getItem("dates5") ],
          [456, localStorage.getItem("positives6") ]  ,// ]  , // localStorage.getItem("dates6") ],
          [456, localStorage.getItem("positives7") ]  ,// ]  , // localStorage.getItem("dates7") ],
          [456, localStorage.getItem("positives8") ]  ,// ]  , // localStorage.getItem("dates8") ],
          [456, localStorage.getItem("positives9") ]  ,// ]  , // localStorage.getItem("dates9") ],
          [456, localStorage.getItem("positives10") ]  ,// ]  , // localStorage.getItem("dates10") ],
          [456, localStorage.getItem("positives11") ]  ,// ]  , // localStorage.getItem("dates11") ],
          [456, localStorage.getItem("positives12") ]  ,// ]  , // localStorage.getItem("dates12") ],
          [456, localStorage.getItem("positives13") ]  ,// ]  , // localStorage.getItem("dates13") ],
          [456, localStorage.getItem("positives14") ]  // ]   // localStorage.getItem("dates14") ]
        ]
      }
    ],
    []
