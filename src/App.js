  ...
  return (
    ...
    <div className="App" >
      ...
      <Alert className="alerts" id="frequently_asked_questions" variant="primary" onClose={() => hide_frequently_asked_questions()} dismissible hidden="true">
        <Alert.Heading className="alert-headings">Frequently Asked Questions</Alert.Heading><br></br>
        <p>
      ...
      {/* <Table>
        ...
        <Table className="table">
          ...
          <tbody>
            ...
            <tr className="table-row">
              <a href="#If-You-or-Someone-You-Know-is-Sick-or-Had-Contact-with-Someone-who-Has-COVID-19"><td className="tdleft" >If You or Someone You Know is Sick or <br></br> Had Contact with Someone who Has COVID-19</td></a>
            ...
            <tr className="table-row">
              ...
              <a href="#Community-Mitigation"><td  className="tdcenter">Community Mitigation</td></a>
